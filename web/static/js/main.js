...
var _user$project$Pages_Login_Model$emptyModel = {email: '', password: ''};
var _user$project$Pages_Login_Model$Model = F2(
	function (a, b) {
...
var _user$project$Pages_Login_Update$decodeUserResponse = A5(
	_elm_lang$core$Json_Decode$object4,
...
var _user$project$Pages_Login_Update$init = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[]));
var _user$project$Pages_Login_Update$never = function (n) {
	never:
	while (true) {
		var _v0 = n;
		n = _v0;
...
var _user$project$Pages_Login_Update$translator = F2(
	function (_p0, msg) {
		var _p1 = _p0;
		var _p2 = msg;
		if (_p2.ctor === 'ForSelf') {
			...
			if (_p2._0.ctor === 'UserLoggedIn') {
				return _p1.onUserLoggedIn(_p2._0._0);
			} else {
				return _p1.onNotify(_p2._0._0);
			}
		}
	});
var _user$project$Pages_Login_Update$TranslationDictionary = F3(
	function (a, b, c) {
		return {onInternalMessage: a, onUserLoggedIn: b, onNotify: c};
	});
var _user$project$Pages_Login_Update$TryLocalLogin = {ctor: 'TryLocalLogin'};
var _user$project$Pages_Login_Update$SetPassword = function (a) {
	return {ctor: 'SetPassword', _0: a};
};
var _user$project$Pages_Login_Update$SetEmail = function (a) {
	return {ctor: 'SetEmail', _0: a};
};
var _user$project$Pages_Login_Update$LoginSucceed = function (a) {
	return {ctor: 'LoginSucceed', _0: a};
};
var _user$project$Pages_Login_Update$LoginFail = function (a) {
	return {ctor: 'LoginFail', _0: a};
};
var _user$project$Pages_Login_Update$Notify = function (a) {
	return {ctor: 'Notify', _0: a};
};
var _user$project$Pages_Login_Update$UserLoggedIn = function (a) {
	return {ctor: 'UserLoggedIn', _0: a};
};
var _user$project$Pages_Login_Update$ForParent = function (a) {
	return {ctor: 'ForParent', _0: a};
};
var _user$project$Pages_Login_Update$generateParentMessage = function (outMsg) {
	return A3(
		_elm_lang$core$Task$perform,
		_user$project$Pages_Login_Update$never,
		_user$project$Pages_Login_Update$ForParent,
		_elm_lang$core$Task$succeed(outMsg));
};
var _user$project$Pages_Login_Update$ForSelf = function (a) {
	return {ctor: 'ForSelf', _0: a};
};
var _user$project$Pages_Login_Update$localLogin = function (model) {
	...
	var createSessionRequest = A3(
		_lukewestby$elm_http_builder$HttpBuilder$send,
		_lukewestby$elm_http_builder$HttpBuilder$jsonReader(_user$project$Pages_Login_Update$decodeUserResponse),
		_lukewestby$elm_http_builder$HttpBuilder$jsonReader(_user$project$Pages_Login_Update$decodeErrorResponse),
		A2(
	...
	return A2(
		...
		_user$project$Pages_Login_Update$ForSelf,
		A3(_elm_lang$core$Task$perform, _user$project$Pages_Login_Update$LoginFail, _user$project$Pages_Login_Update$LoginSucceed, createSessionRequest));
};
var _user$project$Pages_Login_Update$update = F2(
	function (msg, model) {
		var _p3 = msg;
		switch (_p3.ctor) {
			case 'LoginSucceed':
			...
			default:
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Pages_Login_Update$localLogin(model)
				};
		}
	});
				...
				_1: _elm_lang$core$Json_Encode$object(
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_1: _elm_lang$core$Json_Encode$string(model.passwordConfirmation)
						}
						]))
			}
			]));
...
var _user$project$App_Common$NotificationsReceived = function (a) {
	return {ctor: 'NotificationsReceived', _0: a};
};
var _user$project$App_Common$UserLoggedIn = function (a) {
	return {ctor: 'UserLoggedIn', _0: a};
};
...
var _user$project$App_Update$update = F2(
	function (appMsg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'PageLogin':
				var _p1 = A2(_user$project$Pages_Login_Update$update, _p0._0, model.pageLogin);
				...
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							A2(_elm_lang$core$Platform_Cmd$map, _user$project$App_Update$loginTranslator, loginCmd)
						]));
			case 'PhoenixMsg':
			...
			case 'PageSignUp':
				var _p3 = A2(_user$project$Pages_SignUp_Update$update, _p0._0, model.pageSignUp);
				var signUpModel = _p3._0;
				var signUpCmd = _p3._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
			...
			case 'DismissNotification':
				...
				var test = A2(_elm_lang$core$Debug$log, 'notifications', model.notifications);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
			...
			case 'NotificationsReceived':
				var notifications$ = A2(_elm_lang$core$Array$append, model.notifications, _p0._0);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
...
var _user$project$Components_AuthOptionsCard$view = F2(
	function (title, providers) {
		var submitBtn = A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_user$project$Pages_Login_Update$ForSelf(_user$project$Pages_Login_Update$TryLocalLogin))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
		...
		var formInput = F4(
			function (inputType, labelText, id$, inputMsg) {
				return A2(
		...
		var loginForm = A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					'email',
					function (_p0) {
						return _user$project$Pages_Login_Update$ForSelf(
							_user$project$Pages_Login_Update$SetEmail(_p0));
					}),
					A4(
					formInput,
					'password',
					...
					function (_p1) {
						return _user$project$Pages_Login_Update$ForSelf(
							_user$project$Pages_Login_Update$SetPassword(_p1));
					}),
					submitBtn
				]));
		var listItem = F2(
...
var _user$project$Pages_SignUp_View$signUpForm = function (model) {
	...
	var formGroup = F2(
		function (additionalClasses, content) {
			var defaultClasses = _elm_lang$core$Native_List.fromArray(
				[
					{ctor: '_Tuple2', _0: 'form-group', _1: true}
				]);
			var classes = A2(_elm_lang$core$List$append, defaultClasses, additionalClasses);
			return A2(
	...
	var displayNameField = function () {
		var errors = A2(_elm_lang$core$List$filterMap, _elm_lang$core$Basics$identity, model.displayNameErrors);
		var isValid = _elm_lang$core$List$isEmpty(errors);
		var groupClasses = _elm_lang$core$Native_List.fromArray(
			[
				{
				ctor: '_Tuple2',
				_0: 'has-success',
				_1: (_elm_lang$core$Native_Utils.cmp(
					_elm_lang$core$String$length(model.displayName),
					0) > 0) && isValid
			},
				{
				ctor: '_Tuple2',
				_0: 'has-warning',
				_1: _elm_lang$core$Basics$not(isValid)
			}
			]);
		return A2(
			formGroup,
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('text-help m-l-1')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(
	...
	var emailField = function () {
		var inputClasses = _elm_lang$html$Html_Attributes$classList(
			_elm_lang$core$Native_List.fromArray(
				[
					{ctor: '_Tuple2', _0: 'form-control', _1: true}
				]));
		var errors = A2(_elm_lang$core$List$filterMap, _elm_lang$core$Basics$identity, model.emailErrors);
		var isValid = _elm_lang$core$List$isEmpty(errors);
		var groupClasses = _elm_lang$core$Native_List.fromArray(
			[
				{
				...
				_0: 'has-success',
				_1: (_elm_lang$core$Native_Utils.cmp(
					_elm_lang$core$String$length(model.email),
					0) > 0) && isValid
			},
				{
				ctor: '_Tuple2',
	...
	var passwordField = function () {
		var errors = A2(_elm_lang$core$List$filterMap, _elm_lang$core$Basics$identity, model.passwordErrors);
		var isValid = _elm_lang$core$List$isEmpty(errors);
		var groupClasses = _elm_lang$core$Native_List.fromArray(
			[
				{
...
var _user$project$Components_Notificationbar$notificationItem = F2(
	function (index, notification) {
		var clickAction = _elm_lang$html$Html_Events$onClick(
			_user$project$App_Common$DismissNotification(index));
		var classes = function () {
			var _p0 = notification.level;
			switch (_p0.ctor) {
				case 'Error':
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_fapian$elm_html_aria$Html_Attributes_Aria$ariaLabel('Close'),
							clickAction
						]),
					_elm_lang$core$Native_List.fromArray(
						[
					...
					_elm_lang$html$Html$text(notification.content)
				]));
	});
var _user$project$Components_Notificationbar$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		A2(
			_elm_lang$core$List$map,
			_elm_lang$core$Basics$uncurry(_user$project$Components_Notificationbar$notificationItem),
			A2(
				_elm_lang$core$List$filter,
				function (pair) {
					return _user$project$Components_Notificationbar$isNotDismissed(
						_elm_lang$core$Basics$snd(pair));
				},
				_elm_lang$core$Array$toIndexedList(model))));
};
...
var _user$project$App_View$viewMainContent = function (model) {
	...
	switch (_p0.ctor) {
		case 'Login':
			return A2(
				_elm_lang$html$Html_App$map,
				_user$project$App_View$loginTranslator,
				_user$project$Pages_Login_View$view(model.pageLogin));
		case 'SignUp':
			return A2(
				_elm_lang$html$Html_App$map,
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$Components_Notificationbar$view(model.notifications),
