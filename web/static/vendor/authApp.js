...
var _user$project$AuthApp$main = {
	main: _elm_lang$html$Html$text('Hello from Elm!')
};

var Elm = {};
Elm['AuthApp'] = Elm['AuthApp'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['AuthApp'], 'AuthApp', typeof _user$project$AuthApp$main === 'undefined' ? null : _user$project$AuthApp$main);
