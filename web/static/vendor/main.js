...
var _krisajenkins$elm_exts$Exts_RemoteData$append = F2(
	function (a, b) {
		var _p8 = {ctor: '_Tuple2', _0: a, _1: b};
		_v7_5:
		do {
			_v7_4:
			do {
				...
				do {
					...
					do {
						switch (_p8._0.ctor) {
							...
							case 'Failure':
								return _krisajenkins$elm_exts$Exts_RemoteData$Failure(_p8._0._0);
							case 'NotAsked':
								switch (_p8._1.ctor) {
									case 'Failure':
										break _v7_2;
					...
					return _krisajenkins$elm_exts$Exts_RemoteData$Failure(_p8._1._0);
				} while(false);
				return _krisajenkins$elm_exts$Exts_RemoteData$NotAsked;
			} while(false);
			return _krisajenkins$elm_exts$Exts_RemoteData$NotAsked;
...
var _user$project$App_Model$Model = F3(
	function (a, b, c) {
		return {activePage: a, pageLogin: b, user: c};
	});
...
var _user$project$App_Update$setActivePageAccess = F2(
	function (user, page) {
		var _p0 = user;
		if (_p0.ctor === 'Success') {
			return _elm_lang$core$Native_Utils.eq(page, _user$project$App_Model$Login) ? _user$project$App_Model$AccessDenied : page;
		} else {
			return _elm_lang$core$Native_Utils.eq(page, _user$project$App_Model$MyAccount) ? _user$project$App_Model$AccessDenied : page;
		}
	});
var _user$project$App_Update$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	_user$project$App_Model$emptyModel,
	_elm_lang$core$Native_List.fromArray(
		[]));
					...
					if (_p3.ctor === 'Success') {
						return _elm_lang$core$Basics$fst(
							A2(
								...
								_user$project$App_Update$SetActivePage(_user$project$App_Model$MyAccount),
								model$));
					} else {
						return model$;
					}
...
var _user$project$App_Router$location2messages = function (location) {
	...
	switch (_p0) {
		...
		case '#404':
			return _elm_lang$core$Native_List.fromArray(
				[
					_user$project$App_Update$SetActivePage(_user$project$App_Model$PageNotFound)
				]);
		default:
			return _elm_lang$core$Native_List.fromArray(
				[
...
var _user$project$App_View$viewFooter = A2(
	_elm_lang$html$Html$div,
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Attributes$class('ui inverted vertical footer segment form-page')
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$href('http://gizra.com'),
							_elm_lang$html$Html_Attributes$target('_blank')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Gizra')
						])),
					A2(
					_elm_lang$html$Html$span,
					_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$href('https://github.com/Gizra/elm-spa-example'),
							_elm_lang$html$Html_Attributes$target('_blank')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('ui avatar image'),
							_elm_lang$html$Html_Attributes$src(_p1._0.avatarUrl)
						]),
					_elm_lang$core$Native_List.fromArray(
						[]))
				]));
...
var _user$project$App_View$viewPageNotFoundItem = function (activePage) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				A2(_user$project$App_View$classByPage, _user$project$App_Model$PageNotFound, activePage),
				_elm_lang$html$Html_Events$onClick(
				_user$project$App_Update$SetActivePage(_user$project$App_Model$PageNotFound))
			]),
		_elm_lang$core$Native_List.fromArray(
...
var _user$project$App_View$navbarAuthenticated = function (model) {
	return _elm_lang$core$Native_List.fromArray(
		[
			A2(
			_elm_lang$html$Html$a,
			_elm_lang$core$Native_List.fromArray(
				[
					A2(_user$project$App_View$classByPage, _user$project$App_Model$MyAccount, model.activePage),
					_elm_lang$html$Html_Events$onClick(
					_user$project$App_Update$SetActivePage(_user$project$App_Model$MyAccount))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('My Account')
				])),
			_user$project$App_View$viewPageNotFoundItem(model.activePage),
			A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('right menu')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					_user$project$App_View$viewAvatar(model.user),
					A2(
					_elm_lang$html$Html$a,
					_elm_lang$core$Native_List.fromArray(
						[
...
var _user$project$App_View$navbarAnonymous = function (model) {
	return _elm_lang$core$Native_List.fromArray(
		[
			A2(
			_elm_lang$html$Html$a,
			_elm_lang$core$Native_List.fromArray(
				[
					A2(_user$project$App_View$classByPage, _user$project$App_Model$Login, model.activePage),
					_elm_lang$html$Html_Events$onClick(
					_user$project$App_Update$SetActivePage(_user$project$App_Model$Login))
				]),
			_elm_lang$core$Native_List.fromArray(
